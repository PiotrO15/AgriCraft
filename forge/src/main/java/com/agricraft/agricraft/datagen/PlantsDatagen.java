...
public class PlantsDatagen {
	...
	public static void registerEnchanted(BootstapContext<AgriPlant> context) {
		r(context, "enchanted", "belladonna", new AgriPlant.Builder().seeds(AgriSeed.builder().item("enchanted:belladonna_seeds").chances(0.0, 1.0, 0.0).build()).stages(4, 6, 6, 10, 10, 14, 14, 16).harvest(4).chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("enchanted:belladonna_flower").count(1, 2, 0.95).build()).requirement(AgriRequirement.builder().humidity(WET, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(HIGH, EQUAL_OR_HIGHER, 0.1).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER).build()).build());
		r(context, "enchanted", "garlic", new AgriPlant.Builder().seeds(AgriSeed.builder().item("enchanted:garlic").chances(0.0, 1.0, 0.0).build()).stages(2, 5, 5, 7, 7, 10, 10, 12).harvest(4).chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("enchanted:garlic").count(1, 5, 0.95).build()).requirement(AgriRequirement.builder().humidity(WET, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(HIGH, EQUAL_OR_HIGHER, 0.1).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER).build()).build());
		r(context, "enchanted", "mandrake", new AgriPlant.Builder().seeds(AgriSeed.builder().item("enchanted:mandrake_seeds").chances(0.0, 1.0, 0.0).build()).stages(4, 5, 5, 7, 7, 9, 9, 12).harvest(4).chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("enchanted:mandrake_root").count(1, 1, 0.95).build()).requirement(AgriRequirement.builder().humidity(WET, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(HIGH, EQUAL_OR_HIGHER, 0.1).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER).build()).build());
		r(context, "enchanted", "snowbell", new AgriPlant.Builder().seeds(AgriSeed.builder().item("enchanted:snowbell_seeds").chances(0.0, 1.0, 0.0).build()).stages(3, 7, 7, 11, 11, 14, 14, 16).harvest(4).chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:snowball").count(1, 1, 0.5).build(), AgriProduct.builder().item("enchanted:icy_needle").count(1, 1, 0.5).build()).requirement(AgriRequirement.builder().humidity(WET, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(HIGH, EQUAL_OR_HIGHER, 0.1).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER).build()).build());
		r(context, "enchanted", "water_artichoke", new AgriPlant.Builder().seeds(AgriSeed.builder().item("enchanted:water_artichoke_seeds").chances(0.0, 1.0, 0.0).build()).stages(2, 4, 4, 5, 5, 9, 9, 14).harvest(4).chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("enchanted:water_artichoke").count(1, 1, 0.95).build()).requirement(AgriRequirement.builder().humidity(WATERY, EQUAL_OR_HIGHER, 0.4).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER).fluid(AgriFluidCondition.builder().fluid("minecraft:water").build()).build()).build());
		r(context, "enchanted", "wolfsbane", new AgriPlant.Builder().seeds(AgriSeed.builder().item("enchanted:wolfsbane_seeds").chances(0.0, 1.0, 0.0).build()).stages(3, 8, 8, 10, 10, 12, 12, 14).harvest(4).chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:wolfsbane_flower").count(1, 1, 0.95).build()).requirement(AgriRequirement.builder().humidity(WET, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(HIGH, EQUAL_OR_HIGHER, 0.1).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER).build()).build());
	}
